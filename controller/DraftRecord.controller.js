sap.ui.define(["sap/ui/core/mvc/Controller", "sap/m/MessageBox", "sap/ui/core/Fragment", "sap/m/MessageToast", "../model/formatter",
	...
	"use strict";
	return e.extend("incture.com.ConnectClient_ReturnCreate.controller.DraftRecord", {
		formatter: a,
		onInit: function () {
			this.users = [];
			var e = this;
		...
		valueHelpRequestUserList: function () {
			var e = this;
			if (!e.userList) {
				e.userList = sap.ui.xmlfragment("incture.com.ConnectClient_ReturnCreate.Fragments.UserList", e);
				...
				for (var l = 0; l * s < r; l++) {
					var i = jQuery.ajax({
						type: "GET",
						contentType: "application/json",
						url: "/DKSHJavaService/dac/getUsers/" + l * s + "&100",
						dataType: "json",
						async: false,
								...
								for (var n = 0; n < i.resources.length; n++) {
									...
									if (d) {
										for (var u = 0; u < d.length; u++) {
											if (d[u].value === "DKSH_RETURN_CREATOR") {
												l.push({
													userId: i.resources[n].id,
		...
		_actionPopover: function (e) {
			...
			var r = this;
			if (!r.ActionPopover) {
				r.ActionPopover = sap.ui.xmlfragment("incture.com.ConnectClient_ReturnCreate.Fragments.ActionPopover", this);
		...
		valueHelpRequestSoldtoParty: function () {
			var e = this;
			if (!e.SoldtoParty) {
				e.SoldtoParty = sap.ui.xmlfragment("incture.com.ConnectClient_ReturnCreate.Fragments.DraftSoldTo", this);
		...
		valueHelpReturnReason: function () {
			var e = this;
			if (!e.returnReason) {
				e.returnReason = sap.ui.xmlfragment("incture.com.ConnectClient_ReturnCreate.Fragments.ReturnReason", this);
		...
		valueHelpOrderType: function (e) {
			...
			if (t.orderTypeDataAccess === "No Access") {
				...
				var t = this;
				if (!t.orderType) {
					t.orderType = sap.ui.xmlfragment("incture.com.ConnectClient_ReturnCreate.Fragments.OrderType", t);
