sap.ui.define(["sap/ui/core/mvc/Controller", "sap/m/MessageBox", "../model/formatter", "sap/m/MessageToast", "sap/ui/core/Fragment",
	...
	"use strict";
	return e.extend("dksh.connectclient.CreateReturn.controller.Selection", {
		formatter: r,
		onInit: function () {
		...
		onCompleteStep2: function () {
			if (!this.invoiceDetail) {
				this.invoiceDetail = sap.ui.xmlfragment("dksh.connectclient.CreateReturn.Fragments.InvoiceDetail", this);
		...
		onPressRemarks: function () {
			if (this.docVersion === "SUCCESS") {} else {
				var e = this;
				if (!e.Remark) {
					e.Remark = sap.ui.xmlfragment("dksh.connectclient.CreateReturn.Fragments.Remark", this);
		...
		personalizationInvDetails: function (e) {
			if (!this.FilterPersonalization) {
				this.FilterPersonalization = sap.ui.xmlfragment("dksh.connectclient.CreateReturn.Fragments.Personalization", this);
		...
		valueHelpRequestShipTo: function (e) {
			...
			t.ShipTO = sap.ui.xmlfragment("dksh.connectclient.CreateReturn.Fragments.ShipTO", t);
		...
		valueHelpRequestBillTo: function (e) {
			...
			var r = this.getView().getModel("invoiceSearchModel");
			var o = this.getView().getModel("baseModel");
			t.BillTo = sap.ui.xmlfragment("dksh.connectclient.CreateReturn.Fragments.BillTo", t);
		...
		valueHelpRequestPayer: function (e) {
			...
			var r = this.getView().getModel("invoiceSearchModel");
			var o = this.getView().getModel("baseModel");
			t.Payer = sap.ui.xmlfragment("dksh.connectclient.CreateReturn.Fragments.Payer", t);
		...
		valueHelpRequestSoldtoParty: function () {
			...
			var t = this;
			if (!t.SoldtoParty) {
				t.SoldtoParty = sap.ui.xmlfragment("dksh.connectclient.CreateReturn.Fragments.SoldtoParty", this);
		...
		onPressAttachment: function (e) {
			...
			var t = this;
			if (!t.attachment) {
				t.attachment = sap.ui.xmlfragment("dksh.connectclient.CreateReturn.Fragments.attachment", this);
		...
		valueHelpBillingType: function () {
			var e = this;
			if (!e.BillingType) {
				e.BillingType = sap.ui.xmlfragment("dksh.connectclient.CreateReturn.Fragments.BillingType", e);
		...
		valueHelpUOM: function (e) {
			...
			r.UOM = sap.ui.xmlfragment("dksh.connectclient.CreateReturn.Fragments.UOM", r);
		...
		onPressInvoiceDetail: function (e) {
			if (sap.ui.Device.system.phone === true) {
				...
				if (!this._oPopover) {
					s.load({
						name: "dksh.connectclient.CreateReturn.Fragments.InvoicePopover",
						controller: this
					}).then(function (e) {
						this._oPopover = e;
						this.getView().addDependent(this._oPopover);
		...
		onPressReturnDetail: function (e) {
			if (sap.ui.Device.system.phone === true) {
				...
				if (!this._oPopover) {
					s.load({
						name: "dksh.connectclient.CreateReturn.Fragments.ReturnPopover",
						controller: this
					}).then(function (e) {
						this._oPopover = e;
						this.getView().addDependent(this._oPopover);
		...
		onPressReturnDetailPopover: function (e) {
			if (sap.ui.Device.system.phone === true) {
				...
				if (!this._oPopover) {
					s.load({
						name: "dksh.connectclient.CreateReturn.Fragments.ReturnPreviewPopover",
						controller: this
					}).then(function (e) {
						this._oPopover = e;
						this.getView().addDependent(this._oPopover);
		...
		onPressExchangeDetailPopover: function (e) {
			if (sap.ui.Device.system.phone === true) {
				...
				if (!this._oPopover) {
					s.load({
						name: "dksh.connectclient.CreateReturn.Fragments.ExchangePreviewPopover",
						controller: this
					}).then(function (e) {
						this._oPopover = e;
						this.getView().addDependent(this._oPopover);
		...
		onPressExchangeDetail: function (e) {
			if (sap.ui.Device.system.phone === true) {
				...
				if (!this._oPopover) {
					s.load({
						name: "dksh.connectclient.CreateReturn.Fragments.ExchangePopover",
						controller: this
					}).then(function (e) {
						this._oPopover = e;
						this.getView().addDependent(this._oPopover);
		...
		addRow: function (e) {
			if (!this.AddMaterial) {
				this.AddMaterial = sap.ui.xmlfragment("dksh.connectclient.CreateReturn.Fragments.AddMaterial", this);
